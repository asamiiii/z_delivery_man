...
class OrdersSection extends StatefulWidget {
  OrdersSection({Key? key, this.order, this.state, this.cubit, this.statusName})
      : super(key: key);
  final Orders? order;
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                //       )
                //     : const SizedBox(),
                widget.order?.currentStatus != 'تم اسنادة الي المغسلة'
                    ? Row(
                        children: [
                          Text(
                            'عدد القطع',
